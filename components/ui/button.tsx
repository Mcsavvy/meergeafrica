...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-slate-950 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-slate-50 shadow hover:bg-slate-900/90",
        destructive:
        ...
        secondary:
          "bg-secondary text-slate-900 shadow-sm hover:bg-slate-100/80",
        primaryOutline:
          "border border-primary bg-white text-primary shadow-sm hover:bg-primary hover:text-white",
        secondaryOutline:
          "border border-secondary bg-white text-secondary shadow-sm hover:bg-secondary hover:text-white",
